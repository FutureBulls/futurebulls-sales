...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full border-b border-stroke bg-gradient-to-r from-white to-gray-1 dark:from-dark-2 dark:to-dark-3 dark:border-stroke-dark shadow-sm">
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-lg border border-stroke bg-white p-2 shadow-sm hover:shadow-md transition-shadow dark:border-dark-3 dark:bg-dark-2 lg:hidden"
          >
